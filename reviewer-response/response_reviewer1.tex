...
ratio is a genuine bounded efficiency $\eta\in[0,100]\%$
...
\end{comment}
\response The Llama multi-step shortfall is now reported as a genuine limitation.
...
effect, and is discussed in Section ``Multi-Action Amplification'' (p.~22).
