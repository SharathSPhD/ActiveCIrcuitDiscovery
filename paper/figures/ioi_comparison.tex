...
\addplot[fill=blue!40, draw=blue!60] coordinates {
    (Random, 51.5) (Greedy, 66.9) (Bandit, 74.4) (POMDP, 1255.0)
};

\addplot[fill=red!40, draw=red!60] coordinates {
    (Random, 53.0) (Greedy, 79.4) (Bandit, 78.4) (POMDP, 983.0)
};
...
\addplot[fill=blue!40, draw=blue!60] coordinates {
    (Random, 37.1) (Greedy, 40.8) (Bandit, 88.2) (POMDP, 90.6)
};

\addplot[fill=red!40, draw=red!60] coordinates {
    (Random, 51.6) (Greedy, 9.5) (Bandit, 76.4) (POMDP, 33.6)
};
