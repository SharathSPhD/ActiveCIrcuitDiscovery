...
\begin{axis}[
    ...
    symbolic x coords={Early (L0--L8), Mid (L9--L17), Late (L18--L25)},
    xtick=data,
...
\addplot[fill=blue!40, draw=blue!60] coordinates {
    (Early (L0--L8), 0.30) (Mid (L9--L17), 0.0) (Late (L18--L25), 0.70)
};

% Multi-step (early-layer dominant: L0-L7 features dominate)
\addplot[fill=red!40, draw=red!60] coordinates {
    (Early (L0--L8), 0.77) (Mid (L9--L17), 0.10) (Late (L18--L25), 0.13)
};

\legend{IOI (indirect object), Multi-step reasoning}
\end{axis}
\end{tikzpicture}
