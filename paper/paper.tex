...
\usetikzlibrary{shapes.geometric, arrows.meta, positioning, fit,
                ...
                matrix, chains, scopes, shadows.blur}
...
\title{Active Circuit Discovery: Expected Free Energy-Guided\\
       Intervention Selection for Mechanistic Interpretability\\
       in Large Language Models}

\author{Sharath~S.~PhD~Candidate,~\IEEEmembership{University of York}%
\thanks{Manuscript received February 2026. Corresponding author: University of York,
Department of Computer Science. This work was conducted as part of the
MSc Computer Science research programme.}%
}

\markboth{IEEE Transactions on Neural Networks and Learning Systems,~Vol.~XX,
No.~X, 2026}%
{Author: Active Circuit Discovery}
...
\begin{IEEEkeywords}
mechanistic interpretability, active inference, expected free energy, circuit
discovery, sparse autoencoders, transformer language models, GPT-2,
intervention selection, causal circuit analysis, variational free energy
\end{IEEEkeywords}
