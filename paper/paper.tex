...
\title{Active Circuit Discovery: A Multi-Action POMDP Agent for\\
       Causal Feature Identification in Transformer Attribution Graphs}
...
No.~X, 2026}%
{Sathish \emph{et al.}: Active Circuit Discovery}
