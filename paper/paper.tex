...
\title{Active Inference for Mechanistic Interpretability:\\
       Bayesian Intervention Selection in Attribution Graphs\\
       of Large Language Models}

\author{%
  \IEEEauthorblockN{Sharath~Sathish, Mominul~Ahsan, and Majid~Latifi}
  \IEEEauthorblockA{University of York, York, UK}%
}

\markboth{IEEE Transactions on Neural Networks and Learning Systems,~Vol.~XX,
No.~X, 2026}%
{Sathish \emph{et al.}: Active Inference for Mechanistic Interpretability}
