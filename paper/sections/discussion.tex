...
the agent's headline performance reflects genuine circuit-structure discovery
or merely the exploitation of steering, which mechanically produces larger KL
...
agent underperforms random selection (Table~\ref{tab:multistep}); this is a
genuine negative result, not an architectural ``feature''. Per-prompt diagnostics
...
\textbf{Discretisation and hyperparameter sensitivity.} Observation thresholds were
...
competitive with or stronger than the agent. A genuine ACDC run is not included
