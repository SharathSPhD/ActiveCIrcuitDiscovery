...
To separate the contribution of the agent's selection policy from that of
the steering action, steering-enabled counterparts of the
...
\paragraph{Hyperparameter sensitivity.} To characterise robustness to the agent's
...
\paragraph{Finer layer-role bins.} To probe the Llama multi-step result, a
