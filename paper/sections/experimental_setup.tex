...
random \emph{and} chooses its intervention type uniformly at random, isolating the
value of learned action selection. (Activation patching to the zero reference
coincides with ablation in our setup, so this control effectively samples between
...
bounded efficiency, and RCK with a percentile bootstrap 95\% confidence interval
